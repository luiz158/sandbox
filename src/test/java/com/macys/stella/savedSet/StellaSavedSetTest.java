...
public final class StellaSavedSetTest extends StellaBaseLoggedInSeleniumTest{
	...
	public final void givenOnHomepage_whenCreateSavedSetIsTriggered_thenNoExceptions(){
		...
		// When
		this.<HomePageDriver> getDriver().createSavedSetOfProducts();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenNoNameSavedSetIsCreated_thenError(){
		// Given
		final String idProduct = this.<HomePageDriver> getDriver().createProduct().fillRandom().create().retrieveId();
		
		// When
		new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().productIds( idProduct ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenNoNameSavedSetIsCreated_thenNavigationDoesNotAdvance(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().productIds( idProduct ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenInvalidSavedSetIsCreated_thenError(){
		...
		// When
		this.<HomePageDriver> getDriver().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( "123" ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenInvalidSavedSetIsCreated_thenNavigationDoesNotAdvance(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = this.<HomePageDriver> getDriver().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( "123" ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenInvalidSavedSetIsCreated_thenTheSavedSetIsNotCreated(){
		...
		// When
		final CreateSavedSetOfProductsDriver createSavedSetOfProductsDriver = this.<HomePageDriver> getDriver().createSavedSetOfProducts().name( nameOfSavedSet ).productIds( "123" );
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithNonNumberValueIsCreated_thenError(){
		...
		// When
		new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( idProduct, "\nwrong" ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithNonNumberValueIsCreated_thenNavigationDoesNotAdvance(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( idProduct, "\nwrong" ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithNonNumberValueIsCreated_thenTheSavedSetIsStillCreated(){
		...
		// When
		final CreateSavedSetOfProductsDriver createSavedSetOfProductsDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( nameOfSavedSet ).productIds( idProduct, "\nwrong" );
		createSavedSetOfProductsDriver.create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithEmptyValueIsCreated_thenTheSavedSetIsStillCreated(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( nameOfSavedSet ).productIds( idProduct, "\n  " ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithValidIdsOnTheSameLine_thenNoErrors(){
		// Given
		final String idProduct1 = this.<HomePageDriver> getDriver().createProduct().fillRandom().create().retrieveId();
		final String idProduct2 = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createProduct().fillRandom().create().retrieveId();
		
		// When
		new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( idProduct1 + ", " + idProduct2 ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetWithValidIdsOnTheSameLine_thenTheSavedSetIsStillCreated(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( nameOfSavedSet ).productIds( idProduct1 + ", " + idProduct2 ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetIsCreatedWithValidProductWithExtraSpaces_thenNoExceptions(){
		...
		// When
		new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( idProduct + " " ).create();
	...
	public final void givenOnCreateSavedSetFromProductPage_whenSavedSetIsCreated_thenNavigationDoesAdvance(){
		...
		// When
		final SavedSetByIdDriver savedSetByIdDriver = new HomePageDriver( this.getWebDriver() ).navigateToCurrent().createSavedSetOfProducts().name( randomAlphabetic( 6 ) ).productIds( idProduct ).create();
