...
-- the exact dataset of the documentation and additional fields are not present in the setup of the application - these were added incrementally 
and would of course continue to be added (would this be an actual application)
...
I also started the work in a iterative manner - the initial setup and fields of the resources were not all added initially (and some are not added in this draft of the work). 
The additional fields and the setup data would be added in another iteration of the application. 
