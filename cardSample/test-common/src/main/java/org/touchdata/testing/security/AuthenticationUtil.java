package org.touchdata.testing.security;

import org.apache.commons.codec.binary.Base64;
import org.touchdata.sec.util.SecurityConstants;
...
public final class AuthenticationUtil {
    ...
    public static RequestSpecification givenBasicAuthenticated() {
        return RestAssured.given().auth().preemptive().basic(SecurityConstants.ADMIN_EMAIL, SecurityConstants.ADMIN_PASSWORD);
    }
